...
class Rental{
    ...
    calculateRentalDuration(){
      let fullDay=(24*60*60*1000)
       let milliSeconds=(this.rentalEndDate.getTime()-this.rentalStartDate.getTime())/fullDay
...
let rented= new Rental(myCar,'James','2019-03-12','2023-06-30')
console.log(rented);
rented.calculateRentalDuration()
...
class Questions{
    constructor(text,options,correctAnswer,userAnswer){
        this.text=text;
...
//marks(number):The total marks given for each question
...
class Quiz{
    constructor(questions,currentQuestionIndex,score,question){
        this.questions=[]
